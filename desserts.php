...
<table height="100%" width="100% cellpadding="0" cellspacing="0" border="0">
	<tr>
	<td valign="top" allign="left" background="img/b.jpeg" style="background-repeat:no-repeat; background-size:100% 100%;">
	<div>
	<center>
<h1 style="color:black;"><b>VIEW FOOD ITEMS</b></h1><br><br>
